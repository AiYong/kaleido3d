...
VkResult  vkCmd::BindBufferMemory(VkDevice Device, VkBuffer Buffer, VkDeviceMemory Memory, VkDeviceSize MemoryOffset)
{
	std::stringstream param;
	param << "vkCmd::BindBufferMemory() device=" << std::hex << std::setfill('0') << Device
